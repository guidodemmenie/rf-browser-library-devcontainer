...
class Query:
    ...
    @renamed_args(mapping={"spName": "function_name", "spParams": "function_params", "sansTran": "no_transaction"})
    def call_function(
        self,
        function_name: str,
        return_type: Any,
        ...
        *,
        ...
        """
        Calls a function `function_name` with the `function_params` - a *list* of parameters the function requires.
